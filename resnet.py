...
def ResNet18(input_shape, classes, include_top=True):
    ...
    """
    return ResNet(input_shape, classes, basic_block, repetitions=[2, 2, 2, 2], include_top=include_top)


def ResNet34(input_shape, classes, include_top=True):
    """ResNet with 34 layers and v2 residual units
    """
    return ResNet(input_shape, classes, basic_block, repetitions=[3, 4, 6, 3], include_top=include_top)


def ResNet50(input_shape, classes, include_top=True):
    """ResNet with 50 layers and v2 residual units
    """
    return ResNet(input_shape, classes, bottleneck, repetitions=[3, 4, 6, 3], include_top=include_top)


def ResNet101(input_shape, classes, include_top=True):
    """ResNet with 101 layers and v2 residual units
    """
    return ResNet(input_shape, classes, bottleneck, repetitions=[3, 4, 23, 3], include_top=include_top)


def ResNet152(input_shape, classes, include_top=True):
    """ResNet with 152 layers and v2 residual units
    """
    return ResNet(input_shape, classes, bottleneck, repetitions=[3, 8, 36, 3], include_top=include_top)
